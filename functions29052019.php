...
function master_insert()
{
	if($_GET['id']!=6)
	{
		...
		for($i=1;$i<=5;$i++)
		{
			if(!empty($_POST['master_name'.$i]))
			{
				...
				{
					$insert=executework("insert into skillistic_masterdata(id,master_type,state,catid,master_value,status,created_on)values('','".$_GET['master_name']."','".$_POST['state']."','".$catid."','".$_POST['master_name'.$i]."','1','".date("Y-m-d H:i:s")."')");
					//echo ("insert into skillistic_masterdata(id,master_type,state,catid,master_value,status,created_on)values('','".$_GET['master_name']."','".$_POST['state']."','".$catid."','".$_POST['master_name'.$i]."','1','".date("Y-m-d H:i:s")."')");
				}
	...
	else if($_GET['id']==6)
	{
		...
		if($count>0)
		{
			$update=executework("update skillistic_payments set amt='".$_POST['payment_per_km']."' where pdate='".date("Y-m-d")."'");
...
function faculty_insert()
{
	if(!empty($_GET['eid']))
	{
		$update=executework("update skillistic_faculty set faculty_name='".$_POST['faculty_name']."',email_id='".$_POST['email_id']."',mobile_no='".$_POST['mobile_no']."',qualification='".$_POST['qualification']."',designation='".$_POST['designation']."',password='".$_POST['password']."',modified_on='".date("Y-m-d H:i:s")."' where id='".$_GET['eid']."'");
		redirect("faculty_mgmt.php?upd=1");
	}
	else
	{
		$insert=executework("insert into skillistic_faculty(id,faculty_name,email_id,mobile_no,qualification,designation,password,created_on,status)values('','".$_POST['faculty_name']."','".$_POST['email_id']."','".$_POST['mobile_no']."','".$_POST['qualification']."','".$_POST['designation']."','".$_POST['password']."','".date("Y-m-d H:i:s")."','0')");
...
function programs_insert()
{
	...
	{
		$insert=executework("insert into skillistic_programs(id,category,prgrm_title,details,status,created_on)values('','".$_POST['category']."','".$_POST['prgrm_title']."','".$_POST['details']."','0','".date("Y-m-d H:i:s")."')");
...
function inst_insert()
{
	if(!empty($_GET['eid']))
	{
		$update=executework("update skillistic_institute set inst_name='".$_POST['inst_name']."',address='".$_POST['address']."',state='".$_POST['state']."',district='".$_POST['district']."',city='".$_POST['city']."',email_id='".$_POST['email_id']."',mobile_no='".$_POST['mobile_no']."',cname='".$_POST['cname']."',details='".$_POST['details']."',modified_on='".date("Y-m-d H:i:s")."' where id='".$_GET['eid']."'");
		redirect("inst_mgmt.php?upd=1");
	}
	else
	{
		$insert=executework("insert into skillistic_institute(id,inst_name,address,city,state,district,email_id,cname,mobile_no,details,status,created_on)values('','".$_POST['inst_name']."','".$_POST['address']."','".$_POST['city']."','".$_POST['state']."','".$_POST['district']."','".$_POST['email_id']."','".$_POST['cname']."','".$_POST['mobile_no']."','".$_POST['details']."','0','".date("Y-m-d H:i:s")."')");
...
function schedule_insert()
{
	...
	$del_date=executework("delete from skillistic_schedule where sdate='".$sdate."'");
	
	for($i=1;$i<=$_POST['hval'];$i++)
	{
		if(!empty($_POST['institute'.$i]))
		{
			$sel=executework("select * from skillistic_schedule where faculty_id='".$_POST['faculty_id'.$i]."' and sdate='".$sdate."'");
			...
			{
				//echo "hello";
				$update=executework("update skillistic_schedule set institution_id='".$_POST['institute'.$i]."',programme_id='".$_POST['programme'.$i]."',stime='".$_POST['time'.$i]."',modified_on='".date("Y-m-d H:i:s")."',sdate='".$sdate."' where faculty_id='".$_POST['faculty_id'.$i]."' and sdate='".$sdate."'");
			...
			//echo "hii";
			//exit();
				$insert=executework("insert into skillistic_schedule(id,faculty_id,institution_id,programme_id,stime,created_on,sdate,status,sc_status)values('','".$_POST['faculty_id'.$i]."','".$_POST['institute'.$i]."','".$_POST['programme'.$i]."','".$_POST['time'.$i]."','".date("Y-m-d H:i:s")."','".$sdate."','Scheduled','1')");
				//echo ("insert into skillistic_schedule(id,faculty_id,institution_id,programme_id,stime,created_on,sdate,status)values('','".$_POST['faculty_id'.$i]."','".$_POST['institute'.$i]."','".$_POST['programme'.$i]."','".$_POST['time'.$i]."','".date("Y-m-d H:i:s")."','".$sdate."','Scheduled')");
				//exit();
...
function faculty_schedule()
{
	...
	if(!empty($sdate))
	{
		...
		if($count>0)
		{
			$update=executework("update skillistic_faculty_schedule set student_name='".$_POST['sname']."',location='".$_POST['location']."',transport_type='".$_POST['see']."',no_kms='".$_POST['nkms']."',cost_transport='".$_POST['nkm2']."',intercity_transport='".$_POST['sitransport']."',room='".$_POST['sroom']."',food='".$_POST['sfood']."',postage='".$_POST['spostage']."',total='".$_POST['stotal']."',modified_on='".date("Y-m-d H:i:s")."'");
			redirect("schedule.php?upd=1&sdate=".$sdate);
		}
		else
		{
			$update=executework("insert into skillistic_faculty_schedule(sdate,student_name,location,transport_type,no_kms,cost_transport,intercity_transport,room,food,postage,total,created_on) values('".$sdate."','".$_POST['sname']."','".$_POST['location']."','".$_POST['see']."','".$_POST['nkms']."','".$_POST['nkm2']."','".$_POST['sitransport']."','".$_POST['sroom']."','".$_POST['sfood']."','".$_POST['spostage']."','".$_POST['stotal']."','".date("Y-m-d H:i:s")."')");
		 	redirect("schedule.php?succ=1&sdate=".$sdate);
		}
	}
	else
	{
...
function support_insert()
{
	...
	if(!empty($_GET['eid']))
	{
		...
		// echo ("update skillistic_support set title='".$_POST['title']."' $fupd,modified_on='".date("Y-m-d H:i:s")."' where id='".$_GET['eid']."'");
		 redirect("support.php?eid=".$_GET['eid']."&upd=1");
	}
	else
	{
