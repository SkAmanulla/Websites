...
{
           // $sel_user=executework("select * from skillistic_faculty where random_code='".$_POST['code']."' and email_id_off='".$_SESSION['faculty_email']."'");
		   $sel_user=executework("select * from skillistic_faculty where random_code='".$_POST['code']."' and email_id_off='".$_SESSION['username']."'");
			//echo ("select * from skillistic_faculty where random_code='".$_POST['code']."' and email_id_off='".$_SESSION['faculty_email']."'");
			//exit();
            ...
            //$updt=executework("update skillistic_faculty set random_code='".$rand_num."' where email_id_off='".$_SESSION['faculty_email']."' ");
            redirect("change_forgot.php");
            }
            else
            {
                $a=1;
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <br>
                    <h3 align="left"   style=" color:white;">Verify Mail</h3>
...
<div class="basic-form-area mg-b-40">
        <div class="container">
           ...
           <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" name="login_form" id="login_form" enctype="multipart/form-data" onSubmit="return code_validation();">
            
                            <div class="form-group-inner">
                                <label class="control-label" for="code" style="color: white">Enter the code</label>
                        <input type="text" placeholder="******" title="Please enter the code" value="" name="code" id="code" class="form-control" style="width:30%;">
