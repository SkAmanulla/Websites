...
function delete_resource(did)
{
	...
	{
		window.location.href="resources.php?did="+did;
		return false;
	}
	else
	{
...
function disable_resource(dis_id)
{
	...
	{
		window.location.href="resources.php?dis_id="+dis_id;
		return false;
	}
	else
	{
...
function enable_resource(ena_id)
{
	...
	{
		window.location.href="resources.php?ena_id="+ena_id;
		return false;
	}
	else
	{
...
function modify(eid)
{
	...
	{
		window.location.href="resources.php?eid="+eid;
		return false;
	}
	else
	{
...
if($pages > 1)
{
		...
		{
			$pr='';
			$prv='resources.php?page_index='.($page12-1);
		}
		if($page12 == $pages)
		{
			$nx="class=disabled";
		...
		{
			$nx='';
			$nxt='resources.php?page_index='.($page12+1);
		}
?>
...
<?php
	  for($im=1;$im<=$pages;$im++)
	  {
		  if($page12 == $im)
			...
			$ac='';
?>
               <li <?php echo $ac; ?>  class="page-number <?php if(!empty($_GET['page_index'])&&($_GET['page_index']==$ac)){echo "active"; }?>"> <a href="resources.php?page_index=<?php echo $im ?>"><?php echo $im; ?></a> </li>
		<?php
	  }
		?>
