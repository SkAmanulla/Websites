...
{
            $sel_user=executework("select * from skillistic_faculty where email_id='".$_POST['username']."' ");
           ...
           // exit();
            ...
            $updt=executework("update skillistic_faculty set random_code='".$rand_num."' where email_id='".$_POST['username']."' ");
...
<div class="basic-form-area mg-b-40">
        <div class="container">
            ...
            <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" name="login_form" id="login_form" enctype="multipart/form-data" onSubmit="return forgot_validation();">
                        ...
                        <input type="text" placeholder="example@gmail.com" title="Please enter you username" value="" name="username" id="username" class="form-control" style="width:30%;">
