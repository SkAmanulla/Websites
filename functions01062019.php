...
function faculty_insert()
{
	...
	else
	{
		...
		{
			$insert=executework("insert into skillistic_faculty(id,faculty_name,faculty_id,zones,email_id_off,email_id_per,mobile_no_off,mobile_no_per,mobile_no_alt,designation,password,created_on,status)values('','".$_POST['faculty_name']."','".$_POST['faculty_id']."','".$_POST['zones']."','".$_POST['email_id_off']."','".$_POST['email_id_per']."','".$_POST['mobile_no_off']."','".$_POST['mobile_no_per']."','".$_POST['mobile_no_alt']."','".$_POST['designation']."','".$_POST['password']."','".date("Y-m-d H:i:s")."','0')");
...
function faculty_schedule()
{
	...
	if(!empty($sdate))
	{
		...
		{
			$update=executework("insert into skillistic_faculty_schedule(sdate,student_name,location,transport_type,no_kms,cost_transport,intercity_transport,room,food,postage,filename,total,created_on) values('".$sdate."','".$_POST['sname']."','".$_POST['location']."','".$_POST['see']."','".$_POST['nkms']."','".$_POST['nkm2']."','".$_POST['sitransport']."','".$_POST['sroom']."','".$_POST['sfood']."','".$_POST['spostage']."','".$file_name."','".$_POST['stotal']."','".date("Y-m-d H:i:s")."')");
