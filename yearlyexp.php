                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
                                            <div class="basic-login-inner">
                                                <h3 style="text-align:center;color:#FFFFFF">Yearly Expenses Report</h3><br>
...
<?php
//$years=year('sdate');
	$sel=executework("select * from skillistic_faculty_schedule where id!='' $faculty  group by faculty_id order by faculty_id desc");
...
if($pages > 1)
{
		...
		{
			$pr='';
			$prv='yearlyexp.php?page_index='.($page12-1).'&faculty='.$faculty_id;
		}
		if($page12 == $pages)
		{
			$nx="class=disabled";
		...
		{
			$nx='';
			$nxt='yearlyexp.php?page_index='.($page12+1).'&faculty='.$faculty_id;
		}
?>
...
<?php
	  for($im=1;$im<=$pages;$im++)
	  {
		  if($page12 == $im)
			...
			$ac='';
?>
               <li <?php echo $ac; ?>  class="page-number <?php if(!empty($_GET['page_index'])&&($_GET['page_index']==$ac)){echo "active"; }?>"> <a href="yearlyexp.php?page_index=<?php echo $im ?>&faculty=<?php echo $faculty_id; ?>"><?php echo $im; ?></a> </li>
		<?php
	  }
		?>
