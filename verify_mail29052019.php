...
include("phpmail/send_mail.php");
$a=0;
if(!empty($_POST['submit']))
{
            $sel_user=executework("select * from skillistic_faculty where random_code='".$_POST['code']."' and email_id='".$_SESSION['email_id']."' ");
            ...
            //echo "rand".$rand_num;
           // exit();
            // $admin_subject1="Skillistic Faculty";
            ...
            $updt=executework("update skillistic_faculty set random_code='' where email_id='".$_SESSION['email_id']."' ");
...
<head>
    ...
    <title>Verify the code | Skillistic Solutions</title>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center m-b-md custom-login" style="margin-top:100px;">
                    <h3 style=" color:black;">Verify the code </h3>
                ...
                <div class="hpanel">
                    ...
                    if($a==1){
                    ?>
                    <div align="center" style="color:#CC0000"><?php echo "You entered wrong code"; ?></div>
                    <?php
                }
                ?>
<style type="text/css">
        ...
        <div class="container">
            ...
            <form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" name="login_form" id="login_form" enctype="multipart/form-data" onSubmit="return code_validation();">
                            ...
                            <div class="form-group-inner">
                                <label class="control-label" for="code">Enter the code</label>
