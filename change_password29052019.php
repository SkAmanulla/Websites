...
{
	$sel=executework("select * from skillistic_faculty where password='".$_POST['old_password']."' and email_id='".$_SESSION['skillistic_admin']."'");
	...
	if($cnt>0)
	{
		$upd=executework("update skillistic_faculty set password='".$_POST['new_password']."' where email_id='".$_SESSION['skillistic_admin']."'");
