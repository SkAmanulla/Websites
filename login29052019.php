...
{
            $sel_user=executework("select * from skillistic_faculty where email_id='".$_POST['username']."' and password='".$_POST['password']."'");
			...
			if($count_user>0)
			{
				...
				$_SESSION['name']=$row_user['faculty_name'];
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center m-b-md custom-login" style="margin-top:100px; margin-bottom: 50px;">
                    <h3 style=" color:black; text-align: left">Login </h3>
            ...
            ?>
            <div align="center" style="color:green">Password changed successfully</div>
            <?php } ?>
<style type="text/css">
#content
{
